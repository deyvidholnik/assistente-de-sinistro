...
export default function LandingPage() {
  ...
  return (
    <div className={`min-h-screen transition-all duration-300 ${isDark ? 'bg-gradient-to-br from-background via-background-gradient-light to-background-gradient-medium' : 'bg-gradient-to-br from-background-gradient-light via-background-gradient-medium to-background'}`}>
      {/* Header */}
      ...
      <section className="py-12 md:py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className={`text-lg md:text-xl mb-6 md:mb-8 max-w-2xl mx-auto px-4 transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
      ...
      {/* Features Section */}
      <section className={`py-12 md:py-20 px-4 transition-all duration-300 ${isDark ? 'bg-gray-800/50' : 'bg-white/50'}`}>
        <div className="container mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className={`text-base md:text-lg max-w-2xl mx-auto px-4 transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 px-4">
            <Card className={`border-0 shadow-lg hover:shadow-xl transition-all duration-300 group ${isDark ? 'bg-gray-700/50 backdrop-blur-sm border border-gray-600/50' : 'bg-gradient-to-br from-blue-50 to-indigo-50'}`}>
              <CardContent className="p-6 md:p-8 text-center">
                ...
                <h3 className={`text-lg md:text-xl font-bold mb-3 md:mb-4 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Leitura Inteligente</h3>
                <p className={`mb-3 md:mb-4 text-sm md:text-base transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <Card className={`border-0 shadow-lg hover:shadow-xl transition-all duration-300 group ${isDark ? 'bg-gray-700/50 backdrop-blur-sm border border-gray-600/50' : 'bg-gradient-to-br from-purple-50 to-pink-50'}`}>
              <CardContent className="p-6 md:p-8 text-center">
                ...
                <h3 className={`text-lg md:text-xl font-bold mb-3 md:mb-4 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Processo Rápido</h3>
                <p className={`mb-3 md:mb-4 text-sm md:text-base transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <Card className={`border-0 shadow-lg hover:shadow-xl transition-all duration-300 group ${isDark ? 'bg-gray-700/50 backdrop-blur-sm border border-gray-600/50' : 'bg-gradient-to-br from-indigo-50 to-blue-50'}`}>
              <CardContent className="p-6 md:p-8 text-center">
                ...
                <h3 className={`text-lg md:text-xl font-bold mb-3 md:mb-4 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Documentação Digital</h3>
                <p className={`mb-3 md:mb-4 text-sm md:text-base transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center px-4">
            <div className="space-y-4 md:space-y-6">
              <div className="flex items-start space-x-3 md:space-x-4">
                ...
                <div>
                  <h3 className={`text-lg md:text-xl font-bold mb-2 transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>Processos Ágeis</h3>
                  <p className={`text-sm md:text-base transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Resolva suas ocorrências em tempo real com nossa tecnologia avançada, sem burocracias desnecessárias.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 md:space-x-4">
                ...
                <div>
                  <h3 className={`text-lg md:text-xl font-bold mb-2 transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>Proteção Completa</h3>
                  <p className={`text-sm md:text-base transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Cobertura total contra roubo, furto, colisão, fenômenos naturais e assistência 24 horas.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 md:space-x-4">
                ...
                <div>
                  <h3 className={`text-lg md:text-xl font-bold mb-2 transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>Atendimento Humanizado</h3>
                  <p className={`text-sm md:text-base transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Equipe especializada e dedicada pronta para ajudar em qualquer momento do dia.</p>
                </div>
              </div>
            </div>
            
            <div className={`bg-gradient-to-br from-background-gradient-light to-background-gradient-medium p-6 md:p-8 rounded-3xl transition-all duration-300 ${isDark ? 'from-blue-900/20 to-purple-900/20' : ''}`}>
              <div className="text-center">
                ...
                <h3 className={`text-xl md:text-2xl font-bold mb-3 md:mb-4 transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>Seu Veículo Protegido</h3>
                <p className={`text-base md:text-lg transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
      ...
      <section className={`py-16 md:py-28 px-4 transition-all duration-300 ${isDark ? 'bg-gray-800/50' : 'bg-white/50'}`}>
        <div className="container mx-auto">
          <div className="text-center mb-16 md:mb-20">
            ...
            <p className={`text-lg md:text-xl max-w-3xl mx-auto px-4 transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-10 px-4 mb-12">
            <Card className={`border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 ${isDark ? 'bg-gray-700/50 backdrop-blur-sm' : 'bg-white'}`}>
              <CardContent className="p-8 md:p-10">
                ...
                <p className={`mb-6 md:mb-8 text-base md:text-lg leading-relaxed transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-700'}`}>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <div className={`font-bold text-base md:text-lg transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Roberto Silva</div>
                    <div className={`text-sm md:text-base transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Associado há 2 messes • Engenheiro</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className={`border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 ${isDark ? 'bg-gray-700/50 backdrop-blur-sm' : 'bg-white'}`}>
              <CardContent className="p-8 md:p-10">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <div className={`font-bold text-base md:text-lg transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Luciana Costa</div>
                    <div className={`text-sm md:text-base transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Associada há 1 ano • Advogada</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className={`border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 ${isDark ? 'bg-gray-700/50 backdrop-blur-sm' : 'bg-white'}`}>
              <CardContent className="p-8 md:p-10">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <div className={`font-bold text-base md:text-lg transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Thiago Moreira</div>
                    <div className={`text-sm md:text-base transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Associado há 6 meses • Desenvolvedor</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            <Card className={`border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 ${isDark ? 'bg-gray-700/50 backdrop-blur-sm' : 'bg-white'}`}>
              <CardContent className="p-8 md:p-10">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <div className={`font-bold text-base md:text-lg transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Maria José</div>
                    <div className={`text-sm md:text-base transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Associada há 2 anos • Professora</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className={`border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 ${isDark ? 'bg-gray-700/50 backdrop-blur-sm' : 'bg-white'}`}>
              <CardContent className="p-8 md:p-10">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <div className={`font-bold text-base md:text-lg transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Carlos Silva</div>
                    <div className={`text-sm md:text-base transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Associado há 1 ano • Empresário</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className={`border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 ${isDark ? 'bg-gray-700/50 backdrop-blur-sm' : 'bg-white'}`}>
              <CardContent className="p-8 md:p-10">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <div className={`font-bold text-base md:text-lg transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Ana Santos</div>
                    <div className={`text-sm md:text-base transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Associada há 2 anos • Médica</div>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="text-center">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="text-center">
                <div className={`text-4xl md:text-5xl font-bold mb-2 transition-colors duration-300 ${isDark ? 'text-blue-400' : 'text-blue-600'}`}>99%</div>
                <div className={`text-base md:text-lg transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Satisfação dos Associados</div>
              </div>
              <div className="text-center">
                <div className={`text-4xl md:text-5xl font-bold mb-2 transition-colors duration-300 ${isDark ? 'text-purple-400' : 'text-purple-600'}`}>+5k</div>
                <div className={`text-base md:text-lg transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Veículos Protegidos</div>
              </div>
              <div className="text-center">
                <div className={`text-4xl md:text-5xl font-bold mb-2 transition-colors duration-300 ${isDark ? 'text-green-400' : 'text-green-600'}`}>98%</div>
                <div className={`text-base md:text-lg transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Recomendariam</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
              <Button size="lg" onClick={() => handleWhatsAppClick("Contratar Proteção")}  className="bg-background text-brand-primary hover:bg-surface-hover px-6 md:px-8 py-4 md:py-6 text-base md:text-lg font-bold w-full sm:w-auto">
                Contratar Proteção 
                <ArrowRight className="w-4 h-4 md:w-5 md:h-5 ml-2" />
              </Button>
              <Link href="/planos">
      ...
      {/* Footer */}
      <footer className={`text-white py-8 md:py-12 px-4 transition-all duration-300 ${isDark ? 'bg-gray-900' : 'bg-gray-900'}`}>
        <div className="container mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
