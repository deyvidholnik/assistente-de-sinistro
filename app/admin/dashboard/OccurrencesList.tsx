...
export function OccurrencesList({
  ...
  return (
    <Card className={`border-0 shadow-lg transition-all duration-300 bg-transparent `}>
      <CardHeader>
          ...
          {metrics.logs.length === 0 ? (
            <Card className='border-dashed border-2 border-gray-300'>
              <CardContent className='p-8 text-center'>
                ...
                <p className='text-sm text-gray-500'>Nenhuma ocorrência encontrada no período selecionado</p>
              </CardContent>
            </Card>
          ) : (
                ...
                <CardContent className='p-4 sm:p-5'>
                  ...
                  <div className='lg:hidden space-y-4'>
                    ...
                    <div className='flex justify-center'>
                      <Badge
                        variant={
                          log.tipo_atendimento === 'assistencia'
                            ? 'default'
                            : log.tipo_sinistro === 'colisao'
                            ? 'destructive'
                            : log.tipo_sinistro === 'pequenos_reparos'
                            ? 'outline'
                            : 'secondary'
                        }
                        className={`text-xs px-3 py-1 ${
                          log.tipo_atendimento === 'assistencia'
                            ...
                            : log.tipo_sinistro === 'colisao'
                            ? 'bg-red-100 text-red-800 border-red-200'
                            : log.tipo_sinistro === 'furto'
                            ? 'bg-orange-100 text-orange-800 border-orange-200'
                            : log.tipo_sinistro === 'roubo'
                            ? 'bg-red-100 text-red-800 border-red-200'
                            : log.tipo_sinistro === 'pequenos_reparos'
                            ? 'bg-green-100 text-green-800 border-green-200'
                            : 'bg-gray-100 text-gray-800 border-gray-200'
                            ...
                            return (
                              <>
                                ...
                                {log.assistencias_tipos && log.assistencias_tipos.length > 0 && (
                                  <span className='ml-1 text-xs text-gray-600'>- {formatarTodasAssistencias(log)}</span>
                                )}
                              </>
                            )
                          })()}
                    ...
                    <div className='bg-gray-50 rounded-lg p-3 space-y-2'>
                      ...
                      <div className='flex items-center justify-between pt-2 border-t border-gray-200'>
                        <div className='flex items-center gap-2'>
                          ...
                          <div className='text-xs text-gray-500'>{formatDate(log.data_criacao)}</div>
                        </div>
                      </div>
                    </div>
                      ...
                      <Dialog>
                        ...
                        >
                          ...
                          {loadingDetalhes ? (
                            ...
                            <OccurrenceDetails dados={selectedSinistro} />
                          ) : null}
                        </DialogContent>
                      </Dialog>
                    </div>
