...
import { Shield, Lock, Eye, EyeOff, Sun, Moon, AlertCircle, Loader2, Mail, ArrowLeft } from 'lucide-react'
        ...
        <div className='w-full max-w-md'>
          <Card className='shadow-2xl transition-all duration-300 bg-card/90 border-border backdrop-blur-sm'>
            <CardHeader className='space-y-1 pb-6'>
              ...
              <CardTitle className='text-2xl font-bold text-center text-foreground'>Login do Sistema</CardTitle>
              <p className='text-center text-sm text-muted-foreground'>Acesse o sistema de gestão</p>
            </CardHeader>
          ...
          <div className='mt-6 text-center'>
            <p className='text-xs text-muted-foreground'>© 2025 PV Auto Proteção. Todos os direitos reservados.</p>
          </div>
        </div>
      </div>
    </div>
