    ...
    <div className="min-h-screen transition-all duration-300 bg-gradient-to-br from-background-gradient-light via-background-gradient-medium to-background">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              <Button
                ...
                className={`hover:bg-surface-hover hover:text-accent-foreground transition-all duration-300 ${isDark ? 'hover:bg-white text-gray-300' : 'hover:bg-blue-50 text-gray-700'}`}
              >
                {isDark ? <Sun className="w-4 h-4" /> : <Moon className="w-4 h-4" />}
              </Button>
              <Link href="/">
                <Button variant="ghost" className={`hover:bg-surface-hover hover:text-accent-foreground transition-all duration-300 ${isDark ? 'hover:bg-white text-gray-300' : 'hover:bg-blue-50 text-gray-700'}`}>
      ...
      <section className="py-12 md:py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-brand-primary via-brand-secondary to-brand-primary bg-clip-text text-transparent leading-tight">
            Escolha seu Plano de
            <br />
            Proteção Veicular
          </h1>
          <p className={`text-lg md:text-xl mb-8 max-w-3xl mx-auto px-4 transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            {planos.map((plano, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-card/50 backdrop-blur-sm border border-border relative">
                ...
                <CardHeader className="text-center pb-4 pt-2">
                  ...
                  <CardTitle className={`text-lg md:text-xl font-bold mb-2 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>
                    {plano.name}
                  </CardTitle>
                  ...
                  <div className={`text-2xl font-bold mb-2 transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>
                    {plano.preco}
                  </div>
                </CardHeader>
                <CardContent className="px-4 md:px-6">
                  <div className="mb-6">
                    <h4 className={`font-semibold mb-3 flex items-center text-sm md:text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>
                      <ShieldCheck className="w-4 h-4 mr-2 text-green-600" />
                      Coberturas
                    </h4>
                    <ul className="space-y-2">
                      {plano.coberturas.map((cobertura, idx) => (
                        <li key={idx} className={`flex items-start text-xs md:text-sm transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  ...
                  <div className="space-y-3">
                    <Button onClick={handleWhatsAppClick} className={`w-full bg-gradient-to-r from-brand-primary to-brand-secondary hover:opacity-90 text-brand-primary-foreground font-semibold py-3 text-sm md:text-base`}>
                      Contratar {plano.name}
                    </Button>
                    <Button variant="outline" onClick={handleWhatsAppClick} className={`w-full py-3 text-sm md:text-base transition-all duration-300 ${isDark ? 'border-gray-500 text-gray-300 hover:bg-gray-700/50' : 'border-gray-300 text-gray-700 hover:bg-gray-50'}`}>
      ...
      <section className={`py-12 md:py-20 px-4 transition-all duration-300 ${isDark ? 'bg-gray-800/50' : 'bg-white/50'}`}>
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 px-4">
            <Card className={`border-0 shadow-lg hover:shadow-xl transition-all duration-300 ${isDark ? 'bg-gray-700/50 backdrop-blur-sm' : 'bg-white'}`}>
              <CardContent className="p-6 md:p-8 text-center">
                <div className="w-16 h-16 bg-gradient-to-r from-status-success to-gradient-secondary-end rounded-2xl flex items-center justify-center mx-auto mb-6">
                  <Clock className="w-8 h-8 text-white" />
                </div>
                <h3 className={`text-xl font-bold mb-4 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Agilidade</h3>
            ...
            <Card className={`border-0 shadow-lg hover:shadow-xl transition-all duration-300 ${isDark ? 'bg-gray-700/50 backdrop-blur-sm' : 'bg-white'}`}>
              <CardContent className="p-6 md:p-8 text-center">
                <div className="w-16 h-16 bg-gradient-to-r from-status-info to-brand-primary rounded-2xl flex items-center justify-center mx-auto mb-6">
                  <Star className="w-8 h-8 text-white" />
                </div>
                <h3 className={`text-xl font-bold mb-4 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Custo-Benefício</h3>
                <p className={`transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <Card className={`border-0 shadow-lg hover:shadow-xl transition-all duration-300 ${isDark ? 'bg-gray-700/50 backdrop-blur-sm' : 'bg-white'}`}>
              <CardContent className="p-6 md:p-8 text-center">
                <div className="w-16 h-16 bg-gradient-to-r from-brand-secondary to-brand-accent rounded-2xl flex items-center justify-center mx-auto mb-6">
                  <Shield className="w-8 h-8 text-white" />
                </div>
                <h3 className={`text-xl font-bold mb-4 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Proteção Total</h3>
                <p className={`transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
