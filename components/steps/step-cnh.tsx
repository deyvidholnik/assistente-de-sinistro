      ...
      <div className="space-y-3 px-1 sm:px-0">
        ...
        <div className="space-y-2 sm:space-y-3">
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
            <Button
              type="button"
              onClick={() => !isUploadDisabled && document.getElementById("cnh-camera")?.click()}
            ...
            <Button
              type="button"
              onClick={() => !isUploadDisabled && document.getElementById("cnh-file")?.click()}
              variant="outline"
              className={`flex-1 h-12 sm:h-14 border-blue-600 text-blue-600 hover:bg-blue-50 ${
