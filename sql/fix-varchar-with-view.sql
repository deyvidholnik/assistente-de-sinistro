-- Corrigir limites de VARCHAR dropando e recriando a view

-- PASSO 1: Dropar a view para permitir alteração das colunas
DROP VIEW IF EXISTS view_sinistros_completos;

-- PASSO 2: Alterar os tipos das colunas
