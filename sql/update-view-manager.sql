-- Atualizar view para incluir campos do sistema de gerente e tokens
...
SELECT 
    ...
    -- Dados CNH próprio (incluindo campos diretos do sinistro)
    ...
    -- Dados CRLV próprio (incluindo campos diretos do sinistro)
    ...
    COALESCE(crlv_proprio.ano_modelo, s.crlv_proprio_ano) as crlv_proprio_ano,
    ...
    COALESCE(s.total_assistencias, 0) as total_assistencias
